                    ...
                    <span class="countdown-row countdown-show4"
                      ><span class="countdown-section"
                        ><span class="countdown-amount"
                          >{{ parseInt(date / (3600 * 24)) }}d</span
                        ></span
                      ><span class="countdown-section"
                        ><span class="countdown-amount"
                          >{{ parseInt((date % (3600 * 24)) / 3600) }}h</span
                        ></span
                      ><span class="countdown-section"
                        ><span class="countdown-amount"
                          >{{ parseInt((date % 3600) / 60) }}m</span
                        ></span
                      ><span class="countdown-section"
                        ><span class="countdown-amount"
                          >{{ parseInt(date % 60) }}s</span
                        ></span
                      ></span
                    >
                  </div>
...
export default {
  ...
  data: () => ({
    ...
    Ads: [
      {
        url: "https://images.unsplash.com/photo-1618913001606-b4d858e24d08?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTg4fHxhcnR3b3JrfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",
        name: "Loading NFTs",
        price: "FREE",
      },
    ],
